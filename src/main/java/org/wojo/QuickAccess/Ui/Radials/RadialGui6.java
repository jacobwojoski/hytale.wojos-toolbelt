...
public class RadialGui6 extends GenericRadialSelectionUi {
    ...
    protected void constructFileSpecificData() {
        ...
        for (int i=0; i < this._NUM_QA_BUTTONS; i++) {
            ...
            String hoverImg = "QuickAccessRadialMenuDrawing_Six_"+String.valueOf(i)+".png";
            String pressImg = "";
        ...
        this._equipedItemButton.buttonHighlightImage = "../Radials/Images/Two/QuickAccessRadialMenuDrawing_Six_Equipped.png";
    }
